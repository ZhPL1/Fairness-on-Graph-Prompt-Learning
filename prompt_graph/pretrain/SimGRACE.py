...
class SimGRACE(PreTrain):
    ...
    def load_graph_data(self):
        if self.dataset_name in ['PubMed', 'CiteSeer', 'Cora','Computers', 'Photo', 'Reddit', 'WikiCS', 'Flickr','ogbn-arxiv', 'Actor', 'Texas', 'Wisconsin', 'pokec_z', 'pokec_n', 'nba', 'credit']:
            self.graph_list = NodePretrain(data = self.graph_list, num_parts=200)
        else:
